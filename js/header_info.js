...
<header class="navbar navbar-expand-lg navbar-light" style="border-bottom: 1px #CECECE solid;">
            <div class="container-fluid">
                <nav class="navbar navbar-light bg-light w-100">
                    <div class="container-fluid">
                      <a class="navbar-brand" href="trangChu.html"><div style="font-size: 35px;" class="fas fa-arrow-left-long"></div></a>
...
document.getElementById('header-info').innerHTML = headerHTML;
});