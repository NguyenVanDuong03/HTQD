...
<div class="mx-4 mt-2 p-3" style="width: 650px; height: 500px; border: 1px black solid;">
                <div class="row">
                    ...
                    <div class="col-8 my-2">
                        <span class="" style="font-size: 20px;">039709972</span>
                    </div>
                    <div class="col-4 my-2">
                    ...
                    <div class="col-8 my-2">
                        <span class="" style="font-size: 20px;">9h00 - 05/06/2024</span>
                    </div>
                    <div class="col-4 my-2">
                        <h5 style="font-weight: bold;" class="">Ngày trả phòng:</h5>
                    </div>
                    <div class="col-8 my-2">
                        <span class="" style="font-size: 20px;">10h00 - 07/06/2024</span>
                    </div>
                    <div class="col-4 my-2">
